...
public class RegisterController {
	...
	public String tregisterimpl(Model m, TrainerVO t, HttpSession session) {
		...
		try {
			...
			Util.saveFile(t.getPf1(), t.getPf2(), t.getPf3(), t.getLc1(), t.getLc2(), t.getLc3(), dir1, dir2, dir3,
					dir4, dir5, dir6);
			session.setAttribute("logincust", t);
		} catch (Exception e) {
			e.printStackTrace();
		}
